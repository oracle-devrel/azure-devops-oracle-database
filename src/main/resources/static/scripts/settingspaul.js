...
function initSdk(name) {
     ...
     */
     //https://cloud.oracle.com/digital-assistant/oda-instances/ocid1.odainstance.oc1.phx.amaaaaaaknuwtjia4ehu7td76buuz43bftq5ejzd34xhhqmhi3nv65gqqwfq/associatedServices?region=us-phoenix-1
     // oda-your-instance-.data.digitalassistant.oci.oraclecloud.com/
     // https://oda-600701a34a6c474fb75befc2c5a70d8e-da3.data.digitalassistant.oci.oraclecloud.com/botsui/
    const chatWidgetSettings = {
        URI: 'oda-600701a34a6c474fb75befc2c5a70d8e-da3.data.digitalassistant.oci.oraclecloud.com/',                               // ODA URI, only the hostname part should be passed, without the https://
        ...
        channelId: '4f877adf-f839-4642-a263-c2a5e109c9cc',                   // Channel ID, available in channel settings in ODA UI, optional if client auth enabled
